...
const apiUrl = 'http://localhost:8088/api/Students';
          ...
          <div style={formContainerStyle} onClick={(e) => e.stopPropagation()}>
            <div style={formColumnStyle}>
              ...
              <div style={formRowStyle}>
                <label style={labelStyle}>
                  First Name:
                  <input style={inputStyle} type="text" name="firstName"  placeholder='First Name' value={newStudent.firstName} onChange={handleInputChange} />
                </label>

                <label style={labelStyle}>
                  Last Name:
                  <input style={inputStyle} type="text" name="lastName"  placeholder='Last Name' value={newStudent.lastName} onChange={handleInputChange} />
                </label>
              </div>
            ...
            <div style={formColumnStyle}>
              ...
              <div style={formRowStyle}>
                <label style={labelStyle}>
                  First Name:
                  <input style={inputStyle} type="text" name="firstName"  placeholder='First Name' value={siblingDetails.firstName} onChange={handleSiblingDetailsChange} />
                </label>

                <label style={labelStyle}>
                  Last Name:
                  <input style={inputStyle} type="text"  placeholder='Last Name' name="lastName" value={siblingDetails.lastName} onChange={handleSiblingDetailsChange} />
                </label>
              </div>
              <div style={formRowStyle}>
                <label style={labelStyle}>
